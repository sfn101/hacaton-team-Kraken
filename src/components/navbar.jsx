                ...
                {navigation.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      className={`group relative flex items-center rounded-lg px-4 py-2 text-sm font-medium transition-all duration-200 ease-in-out hover:scale-105 ${
                        isActive
            ...
            {navigation.map((item) => {
              ...
              return (
                <a
                  ...
                  href={item.href}
                  onClick={(e) => handleNavClick(item.name, e)}
                  className={`group flex items-center rounded-lg px-3 py-2 text-base font-medium transition-all duration-200 ${
                    isActive
